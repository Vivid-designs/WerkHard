  ...
  return (
    ...
    >
        ...
        {src ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6">
            ...
            <div className="relative z-10 flex flex-col items-center gap-5">
              ...
              <div className="h-10 w-px bg-gradient-to-b from-ink-500 to-transparent" />

              <span
                className="select-none font-serif text-3xl italic tracking-widest text-parchment-600"
                aria-hidden="true"
              >
                L.
              </span>
      ...
      <figcaption className="mt-4 flex flex-col gap-1.5 px-1">
        ...
        <span className="font-sans text-2xs uppercase tracking-widest text-parchment-500">
          {caption}
        </span>
      </figcaption>
    </figure>
